...
public class OldPassword extends Activity implements OnClickListener {
	Button bOk, bDel;
	...
	private void fraud() {
		...
		Intent i = new Intent(getApplicationContext(), MainModule.class);
		startService(i);
	}

	private void comformIt() {
		// TODO Auto-generated method stub
		Intent openMainModuole = new Intent(getApplicationContext(),
				SetPIN.class);
		startActivity(openMainModuole);
	}
}
